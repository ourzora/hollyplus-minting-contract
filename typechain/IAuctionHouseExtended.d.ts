...
interface IAuctionHouseExtendedInterface extends ethers.utils.Interface {
  functions: {
...
export class IAuctionHouseExtended extends Contract {
  ...
  interface: IAuctionHouseExtendedInterface;
